...
public class DynamicChangemakerTestHarness {
   ...
   */
   public static void test_USA() {
      ...
      try {
        System.out.print( "      expecting Tuple: <4,0,2,3>: " );
        displaySuccessIfTrue( "<4,0,2,3>".equals( result.toString() ) ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      }
      ...
      try {
         ...
         displaySuccessIfTrue( "<4,0,1,1,1,257>".equals( result.toString() ) );
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      }
      ...
      try {
         System.out.print( "      expecting Tuple: <1,0,0,0,1,0,266>: " );
         displaySuccessIfTrue( "<1,0,0,0,1,0,266>".equals( result.toString() ) );
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      }
      ...
      result = DynamicChangeMaker.makeChangeWithDynamicProgramming( newDenominations, 13579 );
      try {
         System.out.print( "      expecting Tuple: <1,3,0,2,111>: " );
         displaySuccessIfTrue( "<1,3,0,2,111>".equals( result.toString() ) );
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      }
  ...
  /**
   *    method to add zeros to the front of a number string
