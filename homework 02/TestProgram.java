...
public class TestProgram {
   ...
   */
   public static void test_containsVowel() {
      ...
      try { System.out.println( StringStuff.containsVowel( "I am here" ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Test for all uppercase vowels: " );
      try { System.out.println( StringStuff.containsVowel( "ITS ALL UPPER." ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }
      ...
      try { System.out.println( StringStuff.containsVowel( "hghghghg" ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }
   ...
   */
   public static void test_isPalindrome() {
      ...
      try { System.out.println( StringStuff.isPalindrome( "ba" ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'aba' should return true: " );
      try { System.out.println( StringStuff.isPalindrome( "ada" ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'amanaplanacanalpanama' should return true: " );
      try { System.out.println( StringStuff.isPalindrome( "mum" ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'ABBA' should return true: " );
      try { System.out.println( StringStuff.isPalindrome( "ADDA" ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'RaCeCaR' should return true: " );
      try { System.out.println( StringStuff.isPalindrome( "DaCeCaD" ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'madamiamadam' should return false: " );
      try { System.out.println( StringStuff.isPalindrome( "dadamiamadad" ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'abcdefghigfedcba' should return false: " );
      try { System.out.println( StringStuff.isPalindrome( "ebcdefghigfedcbe" ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }
